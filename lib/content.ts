import { contentSdk } from "@webiny/content-sdk-nextjs";
import type { ContentSdkConfig } from "@webiny/content-sdk-nextjs";

type InitOptions = Partial<Pick<ContentSdkConfig, "preview" | "apiTenant" | "wb">>;

export const initializeContentSdk = ({ preview, apiTenant, wb }: InitOptions = {}) => {
    contentSdk.init({
        ...
        apiTenant: apiTenant ?? String(process.env.NEXT_PUBLIC_WEBINY_API_TENANT || "root"),
        preview,
        wb: {
            ...wb,
            componentGroups: [
