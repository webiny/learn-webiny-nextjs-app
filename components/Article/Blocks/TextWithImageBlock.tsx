...
import { GenericBlock, TextWithImageBlock } from "../types";
// import { RichTextLexicalRenderer } from "@webiny/react-rich-text-lexical-renderer";

export const isTextWithImageBlock = (
  block: GenericBlock,
): block is TextWithImageBlock => {
  return block.__typename === "Article_Content_Textwithimageblock";
};

interface TextWithImageBlockComponentProps {
  block: TextWithImageBlock;
}

export const TextWithImageBlockComponent = ({
  block,
}: TextWithImageBlockComponentProps) => {
  return (
